...
enum DSL_TOKEN_OPERATIONS
{
    ...
    TERMINAL        = (uint32_t) (0x00040000), // terminal operator forces run of entire operator stack
...
#define BINARY_UNARY_TERMINAL_MASK  (0x000F0000)
...
#define IS_UNARY_OPERATOR(token_kind)   (((token_kind)&BINARY_UNARY_TERMINAL_MASK) == UNARY)

/// \desc Checks if the value is a binary operator.
#define IS_BINARY_OPERATOR(token_kind)   (((token_kind)&BINARY_UNARY_TERMINAL_MASK) == BINARY)

/// \desc Checks if the value is a terminal operator.
#define IS_TERMINAL_OPERATOR(token_kind)   (((token_kind)&BINARY_UNARY_TERMINAL_MASK) == TERMINAL)
...
enum TokenTypes
{
    ...
    , COMMA                = TOKEN_OPERATOR  | LEFT_TO_RIGHT | TERMINAL   | SET_BINDING_POWER(1)   | SET_TOKEN_ID(44)
    , SEMICOLON            = TOKEN_OPERATOR  | LEFT_TO_RIGHT | TERMINAL   | SET_BINDING_POWER(1)   | SET_TOKEN_ID(45)
    , END_OF_SCRIPT        = TOKEN_STATEMENT | NONE          | TERMINAL   | SET_BINDING_POWER(100) | SET_TOKEN_ID(46)
    ...
    , COLLECTION_BEGIN     = TOKEN_STATEMENT | NONE          | NONE       | SET_BINDING_POWER(100) | SET_TOKEN_ID(115)
    , COLLECTION_END       = TOKEN_STATEMENT | NONE          | NONE       | SET_BINDING_POWER(100) | SET_TOKEN_ID(116)
    , COLLECTION_VALUE     = TOKEN_STATEMENT | NONE          | NONE       | SET_BINDING_POWER(100) | SET_TOKEN_ID(117)
    , KEY_BEGIN            = TOKEN_PARSER    | NONE          | NONE       | SET_BINDING_POWER(100) | SET_TOKEN_ID(118)
    , KEY_END              = TOKEN_PARSER    | NONE          | NONE       | SET_BINDING_POWER(100) | SET_TOKEN_ID(119)
